 ...
 * @author group9
 */
public class OpenMapMenuItem extends MapMenuItem {
    ...
    ****************************/
    ...
    protected void fireActionMapEvent() {
        ActionMapEvent e = new ActionMapEvent(ActionMapEvent.Actions.OPEN);
    ...
    ****************************/
     ...
     */
    public OpenMapMenuItem(String itemName, Character key) {
        super(itemName, key);
        this.initMenuItem();
    }
