...
import gameoflife.gui.GameOfLifeAppletGUI;
...
import gameoflife.gui.GameOfLifeGUI;
...
import gameoflife.gui.toolbar.component.MapChooser;
 ...
 */
public class GameOfLifeAppletLauncher extends JApplet implements QuitGameListener {
    GameOfLifeGUI GUIframe = null;
    
    private void run(boolean accessToData) {
        try {
            /****************************
            ...
            /* MAP CHOOSER */
            MapChooser mapChooser = new MapChooser("Map Chooser", maps);
            if(!accessToData)
                toolBarGUI.addComponent(mapChooser);
             ...
             * INIT FRAME
             ****************************/
            GUIframe = new GameOfLifeAppletGUI(toolBarGUI, gridGUI, menuBarGUI);
            
            /****************************
             * INIT MAP CONTROLLER
             ****************************/
            GUIMapController mapController = null;
            if(accessToData)
                mapController = new GUIMapController(gridGUI, model);
            ...
            /* MAP CHOOSER */
            mapChooser.addMapChangeListener(e);
            if(accessToData)
                mapChooser.addMapChangeListener(mapController);
    ...
    * CONSTRUCTOR
    ****************************/
    public GameOfLifeAppletLauncher() {
    ...
    ****************************/
    ...
    public void init(){
        ...
        boolean accessToDataAllowed = true;
        ...
        if(sec != null) {
            try {
                ...
                accessToDataAllowed = false;
            }
        }
        else
            accessToDataAllowed = false;

        this.run(accessToDataAllowed);
        
        if(this.GUIframe != null && this.GUIframe instanceof GameOfLifeAppletGUI) {
            GameOfLifeAppletGUI app = (GameOfLifeAppletGUI)this.GUIframe;
            Container content = this.getContentPane();
            content.add(app.getContent());
            this.setJMenuBar(app.getMenuBarGUI().getMenuBar());
        }
    }
